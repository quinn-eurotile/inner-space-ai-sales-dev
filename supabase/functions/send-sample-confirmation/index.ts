...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const customerHtml = emailLayout(`
      ...
      <div class="highlight-box">
        <p><strong>Reserve Your Tiles</strong></p>
        <p>You can now reserve up to 200 sq.m of allocated stock using your registered email address (<strong>${sampleOrder.email}</strong>). Visit our website to submit your reservation request.</p>
      </div>
